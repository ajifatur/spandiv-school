...
<div class="wrap wpls-wrap">
	...
	<h2><?php _e( 'Logo Showcase Responsive Slider with ', 'wp-logo-showcase-responsive-slider-slider' ); ?><span class="h-blue"><?php _e( 'Essential Plugin Bundle', 'wp-logo-showcase-responsive-slider-slider' ); ?></span></h2>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder columns-2">
			<div id="post-body-content">
				<h3 class="larger-font"><?php _e( 'Well <span style="color:#388e3c"> optimized</span>, <span style="color:#7b1fa2">light weight</span> & <span style="color:#3e50b4">expandable</span> plugins <br /> for <span style="background:#ff4081; color:#fff;">web site, landing pages &amp; conversions</span>', 'wp-logo-showcase-responsive-slider-slider' ); ?></h3>
				<h3 class=""><?php _e( 'Multiple pre-built template options with <span class="h-orange"> Gutenberg, DIVI, Elementor, Avada, VC/WPbakery </span>etc page builder/themes', 'wp-logo-showcase-responsive-slider-slider' ); ?></h3>
				<h3 class="larger-font"><?php _e( '<span class="h-blue">46 plugins</span>, <span class="h-blue">10 sliders</span> with <span class="h-blue">2000+</span> pre-built templates in <span class="h-blue">Essential Bundle</span>', 'wp-logo-showcase-responsive-slider-slider' ); ?></h3>
				<h3 class=""><?php _e( 'Top plugins category wise:', 'wp-logo-showcase-responsive-slider-slider' ); ?></h3>
						...
						<tr>
							<td>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WPLS_URL; ?>/assets/images/utility-50.png" width="26">
									<img src="<?php echo WPLS_URL; ?>/assets/images/security-icon.png" width="26">
								</div>
							</td>
							<td>
								<ul>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WPLS_URL; ?>/assets/images/utility-50.png" width="26">
									<img src="<?php echo WPLS_URL; ?>/assets/images/inboundwp-50.png" width="26">
								</div>
							</td>
							<td>
								<ul>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WPLS_URL; ?>/assets/images/utility-50.png" width="26">
									<img src="<?php echo WPLS_URL; ?>/assets/images/inboundwp-50.png" width="26">
									<img src="<?php echo WPLS_URL; ?>/assets/images/SlidersPack-50.png" width="26">
									<img src="<?php echo WPLS_URL; ?>/assets/images/security-icon.png" width="26">
								</div>
							</td>
						</tr>
				...
				<div class="wp-icons">
					<ul>
						<li><img src="<?php echo WPLS_URL; ?>/assets/images/utility-50.png" width="18"> - Utility Plugin (Total 39), </li>
						<li><img src="<?php echo WPLS_URL; ?>/assets/images/inboundwp-50.png" width="15">  -  Inbound Maketing (Total 6), </li>
						<li><img src="<?php echo WPLS_URL; ?>/assets/images/SlidersPack-50.png" width="16">  -  SlidersPack (Total 10), </li>
						<li><img src="<?php echo WPLS_URL; ?>/assets/images/security-icon.png" width="16">  -  Essnetial Security</li>
					</ul>
					<a class="epb-cutom-button" href="<?php echo WPLS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Upgrade-PRO-Top-Cat" target="_blank">Buy Now</a>
				</div>
				...
				<table class="wpos-plugin-pricing-table">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<p>Gain access to <strong>Logo Showcase Responsive Slider</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
								<a href="<?php echo WPLS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>	    		
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							...
							<a href="<?php echo WPLS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
				...
				<div id="postbox-container-1" class="postbox-container wpos-sidebar">
					<div class="wpos-epb-wrap">
						...
						<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WPLS_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
					</div>
