						...
						<div class="inside">
							<table class="form-table">
								<tbody>
									<tr>
										<td>
											<p><?php _e('Boost your web site, landing pages & conversions.', 'wp-logo-showcase-responsive-slider-slider'); ?></p> <br/>											
											<a class="button button-primary button-orange" href="<?php echo WPLS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPLS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium ', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
							<p><a class="button button-primary wpos-button-full" href="https://demo.essentialplugin.com/prodemo/pro-logo-showcase-responsive-slider/" target="_blank"><?php _e('View PRO Demo ', 'wp-logo-showcase-responsive-slider-slider'); ?></a></p>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
