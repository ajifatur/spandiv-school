...
?>
<div class="pro-notice"><?php echo sprintf( __( 'Upgrade to <a href="%s" target="_blank">Pro Version</a> with Essential Plugin Bundle to boost your <b>web site, landing pages & conversions</b>.', 'wp-logo-showcase-responsive-slider-slider'), WPLS_PLUGIN_LINK); ?></div>
